    ...
    <div className="min-h-screen bg-white py-12">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="prose prose-gray max-w-none space-y-6">
          <section>
            <h2 className="text-xl font-light mb-3">1. Datenschutz auf einen Blick</h2>
            
            <h3 className="text-lg font-light mb-2 mt-4">Allgemeine Hinweise</h3>
            ...
            <h3 className="text-lg font-light mb-2 mt-4">Datenerfassung auf dieser Website</h3>
            <p className="text-gray-700 text-sm">
          ...
          <section>
            <h2 className="text-xl font-light mb-3">2. Hosting</h2>
            <p className="text-gray-700 text-sm">
          ...
          <section>
            <h2 className="text-xl font-light mb-3">3. Allgemeine Hinweise und Pflichtinformationen</h2>
            
            <h3 className="text-lg font-light mb-2 mt-4">Datenschutz</h3>
            <p className="text-gray-700 text-sm">
            ...
            <h3 className="text-lg font-light mb-2 mt-4">Hinweis zur verantwortlichen Stelle</h3>
            <p className="text-gray-700 text-sm">
            ...
            <p className="text-gray-700 text-sm mt-2">
              ...
              E-Mail: kontakt@knabeart.de
            </p>

            <h3 className="text-lg font-light mb-2 mt-4">Widerruf Ihrer Einwilligung zur Datenverarbeitung</h3>
            <p className="text-gray-700 text-sm">
            ...
            <h3 className="text-lg font-light mb-2 mt-4">Beschwerderecht bei der zuständigen Aufsichtsbehörde</h3>
            <p className="text-gray-700 text-sm">
          ...
          <section>
            <h2 className="text-xl font-light mb-3">4. Datenerfassung auf dieser Website</h2>
            
            <h3 className="text-lg font-light mb-2 mt-4">Cookies</h3>
            <p className="text-gray-700 text-sm">
            ...
            <h3 className="text-lg font-light mb-2 mt-4">Server-Log-Dateien</h3>
            <p className="text-gray-700 text-sm">
            ...
            <h3 className="text-lg font-light mb-2 mt-4">Kontaktformular</h3>
            <p className="text-gray-700 text-sm">
            ...
            <h3 className="text-lg font-light mb-2 mt-4">Anfrage per E-Mail oder Telefon</h3>
            <p className="text-gray-700 text-sm">
          ...
          <section>
            <h2 className="text-xl font-light mb-3">5. Plugins und Tools</h2>
