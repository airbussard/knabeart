    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="py-12 sm:py-16 bg-gradient-to-b from-gray-50 to-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-light mb-3 sm:mb-4 text-gray-900">Galerie</h1>
          <p className="text-lg sm:text-xl text-gray-700">Entdecken Sie meine Kunstwerke</p>
        </div>
      </section>
